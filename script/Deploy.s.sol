...
contract EcdsaVerifyDeploy is Script, RiscZeroCheats {
    ...
    function run() external {
        ...
        EcdsaVerify ecdsaVerify = new EcdsaVerify(verifier);
        console2.log("Deployed EcdsaVerify to", address(ecdsaVerify));
